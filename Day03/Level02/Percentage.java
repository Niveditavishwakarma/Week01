...
public class StudentGradeCalculator {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numberOfStudents; i++) {
            ...
            if (percentages[i] >= 80) {
                grades[i] = 'A';
            } else if (percentages[i] >= 70&& percentage[i]<=79) {
                grades[i] = 'B';
            } else if (percentages[i] >= 60 && percentage[i]<= 69) {
                grades[i] = 'C';
            } else if (percentages[i] >= 50 && percentage[i]<= 59) {
                grades[i] = 'D';
			}
			else if (percentages[i] >= 40 && percentage[i]<= 49) {
                grades[i] = 'E';
